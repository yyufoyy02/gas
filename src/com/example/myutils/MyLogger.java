...
import com.example.gas.MyApplication;
...
public class MyLogger {
	...
	private static final String VIKING = "@my@ ";
	private static final String ELEVEN = "@ee@ ";
	 ...
	 * @return
	 */
	public static MyLogger ViKingLog() {
		if (klog == null) {
			klog = new MyLogger(VIKING);
		}
		return klog;
	}
	 ...
	 * @return
	 */
	public static MyLogger ElevenLog() {
		if (jlog == null) {
			jlog = new MyLogger(ELEVEN);
		}
		return jlog;
	}
	...
	public void showToast(String str) {
		if (logFlag) {
			MyToast.showToast(MyApplication.getInstance().mContext, str + "",
					5000);
			Log.e(tag, str);
		}
	}
