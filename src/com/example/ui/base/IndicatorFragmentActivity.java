...
public abstract class IndicatorFragmentActivity extends FragmentActivity
	...
	private final void initViews() {
		...
		mPager = (ViewPager) findViewById(R.id.main_home);
		...
		mIndicator.setOnClickListener(new OnTitleClickListener() {

			@Override
			public void onClick() {
				if (mLastTab == mCurrentTab) {
					mOnToTopListeners.get(mCurrentTab).onToTop();
				}
	...
	protected int getMainViewResId() {
		return R.layout.homeactivity_main;
	}
	...
	public interface OnMainFragmenToTopListener {
		public void onToTop();
	}

	public void setOnFragmenToTopListener(OnMainFragmenToTopListener listener) {
		mOnToTopListeners.add(listener);
	}
}
